...
public class AssociateTherapistLambda implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent event, Context context) {
        ...
        try {
            ...
            UpdateItemRequest request = UpdateItemRequest.builder()
                    ...
                    .updateExpression("ADD therapist_ids :therapistId")
                    .expressionAttributeValues(Map.of(":therapistId", AttributeValue.builder().ss(therapistId).build()))
                    .build();

            dynamoDbClient.updateItem(request);
            return response.withStatusCode(200).withBody("{\"message\": \"Therapist associated successfully\"}");
        } catch (Exception e) {
